        ...
        <div
          className={`w-fit max-w-[92vw] md:max-w-[72%] px-4 py-2.5 rounded-2xl wrap-break-word overflow-hidden leading-relaxed ${
            isUser
              ...
              : "bg-[#18181b] text-slate-200 rounded-tl-sm"
          }`}
        >
          {images.length > 0 && (
          ...
          <Markdown
            ...
            components={{
              ...
              code({ inline, className, children }) {
                ...
                if (inline || !match) {
                  return (
                    <code className="px-1.5 py-0.5 rounded bg-white/10 text-indigo-200 wrap-break-word">
                      {value}
                    </code>
                  );
                }
                  ...
                  <div className="my-4 overflow-hidden rounded-xl border border-white/10 bg-[#111318]">
                    <div className="flex items-center justify-between bg-[#1b1d24] border-b border-white/10 px-4 py-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 text-xs hover:text-indigo-300 transition"
                      >
                        {copiedCode === value ? (
                          <>
                            <Check size={14} />
